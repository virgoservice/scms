...
public class CommentVo {
	...
	public CommentVo(int id, int type, int contentId, int agree,
			int replyCount, byte status, int creatorId, Date createTime,
			String text, String userName, String avatar) {
		super();
		this.id = id;
		this.type = type;
		this.contentId = contentId;
