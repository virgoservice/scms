...
<body class="pos-r">
<div class="pos-a" style="width:240px;left:0;top:0; bottom:0; height:100%; border-right:1px solid #e5e5e5; background-color:#f5f5f5">
	<ul id="channelTree" class="ztree">
	</ul>
</div>
<input type="hidden" id="ctx" value="<%=path%>" />
<IFRAME ID="cc" Name="testIframe" FRAMEBORDER=0 src="<%=path %>/admin/content/channel/0"
