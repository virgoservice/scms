...
<article class="page-container">
	<sf:form action="./moduleSave" modelAttribute="module" method="post" class="form form-horizontal" id="form-module-add">
		<div class="row cl">
...
<script type="text/javascript" src="<%=path %>/resources/defaultScript/com.seelecloud.scms.moduleSave.js"></script> 
<!--/_footer /作为公共模版分离出去--> 
</body>
</html>
